export default class {
    ...
    render() {
        ...
        ctx.strokeStyle = (this.parent.scene.parent.settings.theme === "dark" || this.parent.scene.parent.theme === "midnight") ? "#666" : "#aaa";
        ...
        ctx.strokeStyle = this.parent.scene.parent.settings.theme === "dark" ? "#fbfbfb" : this.parent.scene.parent.theme === "midnight" ? "#ccc" : "#000";
